...
import { changeAdminPassword, type AdminPasswordResult } from '@/lib/actions/admin-profile'
...
async function action(
  ...
  return changeAdminPassword(_prev, formData)
}
  ...
  return (
    ...
    >
      <form ref={formRef} action={formAction} noValidate className="space-y-4">
        <div>
          <label htmlFor="admin-current-password" className="block text-sm font-medium text-foreground mb-1.5">
            Current password
          </label>
          <Input
        ...
        <div>
          <label htmlFor="admin-new-password" className="block text-sm font-medium text-foreground mb-1.5">
            New password
          </label>
          <Input
        ...
        <div>
          <label htmlFor="admin-confirm-password" className="block text-sm font-medium text-foreground mb-1.5">
