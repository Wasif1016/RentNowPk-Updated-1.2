...
import { changeVendorPassword, type VendorPasswordResult } from '@/lib/actions/vendor-profile'
  ...
  return (
    ...
    >
      <form ref={formRef} action={formAction} noValidate className="space-y-4">
        <div>
          <label htmlFor="vendor-current-password" className="block text-sm font-medium text-foreground mb-1.5">
            Current password
          </label>
          <Input
        ...
        <div>
          <label htmlFor="vendor-new-password" className="block text-sm font-medium text-foreground mb-1.5">
            New password
          </label>
          <Input
        ...
        <div>
          <label htmlFor="vendor-confirm-password" className="block text-sm font-medium text-foreground mb-1.5">
