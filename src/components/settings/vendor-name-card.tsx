...
import { updateVendorPersonalName, type VendorPersonalNameResult } from '@/lib/actions/vendor-profile'
...
export function VendorNameCard({ initialFullName }: { initialFullName: string }) {
  ...
  return (
    ...
    >
      <form action={formAction} noValidate className="space-y-4">
        <div>
          <label htmlFor="vendor-fullName" className="block text-sm font-medium text-foreground mb-1.5">
            Full name
          </label>
          <Input
            id="vendor-fullName"
