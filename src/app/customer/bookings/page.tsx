    ...
    <div className="px-6 pt-8 pb-10 lg:px-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Track your rental requests and communicate with vendors.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <StatCard
          ...
          subtitle={stats.pending > 0 ? 'Awaiting vendor response' : 'All caught up'}
          icon={AlertCircle}
          iconBg="bg-purple-50"
          ...
          <div className="px-6 py-12 text-center">
            ...
            <p className="text-muted-foreground text-sm">
              {statusFilter
                ...
                : 'No bookings yet. Request a vehicle from search to start a conversation.'}
            </p>
            {!statusFilter && (
            ...
            {totalPages > 1 && (
              <div className="px-6 py-4 border-t border-border flex justify-between items-center flex-wrap gap-3">
                ...
                <div className="flex gap-1">
                  {page > 1 && (
                    <Link
                      href={`/customer/bookings?status=${statusFilter}&page=${page - 1}`}
                      scroll={false}
                    >
                  ...
                  {Array.from({ length: Math.min(totalPages, 5) }, (_, i) => {
                    ...
                    return (
                      <Link
                        key={pageNum}
                        href={`/customer/bookings?status=${statusFilter}&page=${pageNum}`}
                        scroll={false}
                      >
                        <Button
